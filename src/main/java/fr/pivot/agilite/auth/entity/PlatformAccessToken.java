 ...
 * {@code agilite}) and deliberately minimal — only the columns
 * {@link fr.pivot.agilite.auth.TokenValidationService} needs to duplicate {@code
 ...
 * findBy...} query methods on {@link fr.pivot.agilite.auth.repository.AccessTokenReadRepository}
