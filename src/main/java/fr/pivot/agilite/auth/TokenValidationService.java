 ...
 * architecture is meant to avoid). Replicates {@code fr.pivot.collaboratif.auth.TokenValidationService}
 * verbatim (EN08.3 precedent).
 *
 ...
 * fr.pivot.agilite.context.RequestPrincipalResolver}) maps that uniformly to a generic 401
